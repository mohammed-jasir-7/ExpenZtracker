...
import '../../Transaction/widget/tab_one.dart';

class AllListTransaction extends StatefulWidget {
  const AllListTransaction({super.key});

  @override
  State<AllListTransaction> createState() => _AllListTransactionState();
}

class _AllListTransactionState extends State<AllListTransaction> {
  @override
                    ...
                    child: Card(
                      child: ExpansionTile(
                        ...
                        leading: Column(
                          ...
                          children: [
                            CustomText(
                              content: value.allList[index].date.day.toString(),
                              size: 20,
                            ...
                            CustomText(
                                content:
                                    value.allList[index].date.year.toString()),
                          ],
                        ),
                        trailing: CustomText(
                          content:
                              ' +\u20b9 ${value.allList[index].amount.toString()}',
                          colour: value.allList[index].category.categoryType ==
